view: Internet_Sales___No_PII {
    ...
    sql_table_name: "Sales Insights_develop"."Internet Sales - No PII";;
    ...
    dimension: Order_Calculation_Group_Date_Month {
        label: "Order Calculation Group Date Month"
        group_label: "Calculated Groups"
        type: string
        description: "none"
        sql: ${TABLE}."Order Calculation Group Date Month";;
    }

    dimension: Ship_Calculation_Group_Date_Month {
        label: "Ship Calculation Group Date Month"
        group_label: "Calculated Groups"
        type: string
        description: "none"
        sql: ${TABLE}."Ship Calculation Group Date Month";;
    }
    ...
    measure: SemiAdditive_Product_Dimension {
        label: "SemiAdditive_Product_Dimension"
        group_label: "Product Metrics"
        value_format: "#,##0.00"
        type: average
        sql: ${TABLE}."SemiAdditive_Product_Dimension";;
    }
    ...
    set: Customer_Details {
        fields: [orderquantity1,salesamount1,Geography_City_State,Geography_Zip_Zip_Code,Geography_City_City]
    }

    set: Shipping_Details {
        fields: [orderquantity1,salesamount1,Color_hierarchy_Color,Size_hierarchy_Size,Style_hierarchy_Style,Product_Dimension_hierarchy_Product_Name]
    }
